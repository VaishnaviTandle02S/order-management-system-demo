    ...
    <div class="card shadow-sm border" style="width:100%; max-width:420px;">
        <div class="card-body p-4 p-md-5">
            ...
            <div class="border-start border-4 border-primary ps-3 mb-4">
                ...
                <p class="text-muted small mb-0">Register to start managing your orders</p>
            </div>
            ...
            <form action="<c:url value='/register'/>" method="post">
                ...
                <button class="btn btn-primary w-100 fw-semibold" type="submit">Create Account</button>
            </form>

            <hr class="my-4">

            <p class="text-center text-muted small mb-0">
                Already have an account? <a href="<c:url value='/login'/>" class="text-primary fw-semibold text-decoration-none">Sign In</a>
            </p>
